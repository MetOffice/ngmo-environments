...
class PyUmPpibm(PythonPackage):
    ...
    """Unified Model PP IBM.

    This um_ppibm module provides a Python extension for a limited
    subset of the functionality in the SHUMlib data_conv library,
    which is optionally used by the mule-convpp utility.
    """

    homepage = "https://code.metoffice.gov.uk"
    url = "https://github.com/metomi/mule/archive/refs/tags/2022.05.1.tar.gz"
    build_directory = "um_ppibm"
