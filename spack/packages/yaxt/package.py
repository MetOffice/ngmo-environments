...
class Yaxt(AutotoolsPackage):
    ...
    version(
        "0.9.3.1", "5cc2ffeedf1604f825f22867753b637d41507941b7a0fbbfa6ea40637a77605a"
    )
    version(
        "0.9.0",
        "d3673e88c1cba3b77e0821393b94b5952d8ed7dc494305c8cf93e7ebec19483c",
        url="https://swprojects.dkrz.de/redmine/attachments/download/498/yaxt-0.9.0.tar.gz",
    )
    ...
    def setup_build_environment(self, env):
        ...
        if "intel-oneapi-mpi" in self.spec:
            env.prepend_path(
                "PATH", self.spec["intel-oneapi-mpi"].package.component_prefix.bin
            )
